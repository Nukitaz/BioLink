...
** Prompt de Aceleración con IA:**
"Actúa como un diseñador UX/UI especializado en landing pages de conversión. Diseña la estructura en texto (wireframe esquemático)
para un BioLink personal de una desarrolladora de software. Debe priorizar: 1) Foto y bio corta, 2) Redes sociales principales, 3) Mis 2
mejores proyectos con botón de llamada a la acción, 4) Galería visual de 2 imágenes. Indícame qué contenedores (cajas) debo considerar
para que sea 100% responsivo."

** Prompt de Generación Estructural:** "Genera la estructura semántica en HTML5 para un BioLink siguiendo este esquema: un
<header> con avatar y títulos, un <main> con dos <section> (una de tarjetas de proyectos <article> y otra de galería de
imágenes), y un <footer>. Asegúrate de usar atributos de accesibilidad alt y aria-label."
